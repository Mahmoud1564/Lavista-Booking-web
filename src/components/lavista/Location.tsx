      ...
      <div className="grid gap-10 lg:grid-cols-2 lg:items-stretch lg:gap-14">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-5 max-w-md text-sm leading-relaxed text-muted-foreground md:text-base">
            Tucked into the quiet streets of Nazlet El-Semman, Lavista sits within walking distance
            of the Great Pyramid and the Sphinx. Step out for sunrise at the plateau, return for tea
            on the rooftop.
          </p>
