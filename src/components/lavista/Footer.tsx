    ...
    <footer id="contact" className="relative overflow-hidden border-t border-gold/10 bg-ink">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-4">
        <div className="md:col-span-2">
          <p className="font-display text-3xl text-sand-soft">
            Lavista<span className="text-gold">.</span>
          </p>
          <p className="mt-4 max-w-sm text-sm text-muted-foreground">
            A warm modern stay a short walk from the pyramids. Built for travelers who care about
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-gold px-5 py-2.5 text-sm font-medium text-ink transition hover:bg-gold-soft"
          >
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-sand-soft/80">
            <li className="flex items-start gap-2">
              <MapPin className="mt-0.5 h-3.5 w-3.5 text-gold" /> Nazlet El-Semman, Giza, Egypt
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-3.5 w-3.5 text-gold" /> hello@lavista.stay
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-sand-soft/80">
            <li>
              <a href="#stay" className="transition hover:text-gold">
                Stay
              </a>
            </li>
            <li>
              <a href="#experiences" className="transition hover:text-gold">
                Experiences
              </a>
            </li>
            <li>
            ...
            <li>
              <Link to="/manage-booking" className="transition hover:text-gold">
                Manage booking
              </Link>
            </li>
            <li>
